...
val calendar_color_work = Color(0xFFD81B60)      // Pink
val calendar_color_personal = Color(0xFF1E88E5)  // Blue
val calendar_color_family = Color(0xFF43A047)    // Green
val calendar_color_holiday = Color(0xFFE53935)   // Red
val calendar_color_fitness = Color(0xFF8E24AA)   // Purple
val calendar_color_travel = Color(0xFFFFB300)    // Amber
val calendar_color_study = Color(0xFF0097A7)     // Cyan
val calendar_color_finance = Color(0xFF546E7A)   // Blue Grey